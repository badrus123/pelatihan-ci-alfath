                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="nim" class="form-control" value="<?php echo $data_ke_view['nim'];?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="nama" class="form-control" value="<?php echo $data_ke_view['nama'];?>" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="kelas" class="form-control" value="<?php echo $data_ke_view['kelas'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="jurusan" class="form-control" value="<?php echo $data_ke_view['jurusan'];?>">
                                    </div>
                                </div>
								<div>
